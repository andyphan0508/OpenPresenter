  ...
  return (
    <div className="flex flex-col h-screen bg-[#1a1a1a] text-white overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left sidebar */}
        <div className="w-64 border-r border-[#2a2a2a] flex flex-col overflow-hidden flex-shrink-0">
...
function LivePreviewPanel({
  ...
  return (
    <div className="w-64 border-l border-[#2a2a2a] flex flex-col bg-[#1a1a1a] flex-shrink-0">
      <div className="p-3 border-b border-[#2a2a2a]">
        <p className="text-xs text-[#888] font-medium uppercase tracking-wider">Live Preview</p>
      </div>
      ...
      <div className="p-3 border-b border-[#2a2a2a]">
        ...
        {liveSlide ? (
          ...
          <div
            className="w-full rounded bg-[#111] border border-[#2a2a2a] flex items-center justify-center"
            style={{ aspectRatio: '16/9' }}
          >
            <span className="text-[#444] text-xs">Black</span>
          </div>
        )}
      </div>
      ...
      {/* Next slide */}
      <div className="p-3">
        <p className="text-xs text-[#888] mb-1.5 font-medium">Next</p>
        {nextSlide ? (
          <div
          ...
          >
            ...
            <p className="text-xs text-[#555] mt-1 group-hover:text-white transition-colors text-center">
              Click to go live
            </p>
          </div>
        ) : (
          <div
            ...
            style={{ aspectRatio: '16/9' }}
          >
            <span className="text-[#444] text-xs">End</span>
          </div>
        )}
      </div>
      ...
      {/* Slide navigator */}
      {pres && (
        <div className="flex-1 p-3 border-t border-[#2a2a2a] overflow-hidden flex flex-col">
          <p className="text-xs text-[#888] mb-2 font-medium uppercase tracking-wider">All Slides</p>
          <div className="flex-1 overflow-y-auto space-y-1">
            {pres.slides.map((slide, idx) => (
              ...
              >
                <span className="text-[#444] mr-1">{idx + 1}.</span>
...
function LiveMiniSlide({
  ...
  return (
    <div
      className="w-full rounded overflow-hidden border border-[#2a2a2a]"
