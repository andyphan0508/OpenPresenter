    ...
    <div className="flex h-full overflow-hidden">
      ...
      {selectedSong ? (
        <SongDetail
          ...
          onSectionEditStart={(id, content) => { setEditingSectionId(id); setSectionEditContent(content) }}
          onSectionSave={(sectionId) => handleSectionSave(selectedSong, sectionId)}
          onSectionCancel={() => setEditingSectionId(null)}
          onSectionDelete={(sectionId) => handleSectionDelete(selectedSong, sectionId)}
          onSectionMove={(sectionId, dir) => handleSectionMove(selectedSong, sectionId, dir)}
          onSectionAddToPres={(sectionId) => handleSectionAddToPres(selectedSong, sectionId)}
      ...
      <NewSongDialog
        ...
        markdownContent={markdownContent}
        onClose={() => { setShowNewSongDialog(false); setMarkdownContent('') }}
