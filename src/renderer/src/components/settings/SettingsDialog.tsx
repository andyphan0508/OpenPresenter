...
type Tab = 'display' | 'remote' | 'midi'

export function SettingsDialog({ initialTab = 'display', remoteStatus, onClose }: { initialTab?: Tab; remoteStatus: RemoteStatus; onClose: () => void }) {
