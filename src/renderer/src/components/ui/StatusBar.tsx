  ...
  return (
    <>
      <div className="h-6 bg-panel border-t border-app flex items-center justify-between px-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-4 text-xs text-muted">
          <button onClick={() => setShowShortcuts(true)} className="flex items-center gap-1 hover:text-primary transition-colors">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-in"
          ...
          <div className="bg-panel rounded-xl border border-app p-6 w-96 shadow-2xl modal-in"
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => setShowShortcuts(false)} className="text-muted hover:text-primary"><X className="w-4 h-4" /></button>
            </div>
